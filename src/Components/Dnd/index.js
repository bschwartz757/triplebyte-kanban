...
// import { TodoCard, HeaderCard, AddTodo } from '../Card';
...
class DndContainer extends Component {
  ...
  constructor(props) {
    ...
    const { stateAsArray: parentState, addToDo } = props;
  ...
  render() {
    ...
    return columnOrder.map(colId => {
      ...
      const columnTasks = column.taskIds.map(taskId => tasks[colId][taskId]);
